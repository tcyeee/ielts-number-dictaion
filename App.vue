...
.icon{
    ...
    &--fluent--calendar-date-28-filled{@include icon("data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 28 28'%3E%3Cpath fill='%23000' d='M25 9.5v12.25A3.25 3.25 0 0 1 21.75 25H6.25A3.25 3.25 0 0 1 3 21.75V9.5zm-8.006 2.734q-1.196 0-1.898.639q-.703.639-.703 1.729q0 .627.319 1.116q.32.49.87.77a2.33 2.33 0 0 0-1.02.838a2.17 2.17 0 0 0-.363 1.23q0 1.12.765 1.782T17 21q1.266 0 2.027-.66q.762-.658.762-1.783q0-.68-.36-1.22q-.36-.538-1.029-.849q.558-.28.88-.77q.322-.489.322-1.116q0-1.09-.704-1.729q-.702-.639-1.904-.639m-5.03.088h-.182l-3.328 1.225v1.201l2.092-.715v6.85h1.418zm5.024 4.752q.62 0 1 .39q.377.39.377 1.022q0 .651-.36 1.014T17 19.863t-1.01-.375t-.367-1.002q0-.638.372-1.025q.373-.387.993-.387m.006-3.697q.544 0 .867.36t.323.917q0 .585-.32.932q-.319.346-.864.346t-.864-.346q-.32-.345-.32-.932q0-.592.317-.934q.316-.343.861-.343M21.75 3A3.25 3.25 0 0 1 25 6.25V8H3V6.25A3.25 3.25 0 0 1 6.25 3z'/%3E%3C/svg%3E")}
    ...
    &--bxs--dollar-circle{@include icon("data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cpath fill='%23000' d='M12 2C6.486 2 2 6.486 2 12s4.486 10 10 10s10-4.486 10-10S17.514 2 12 2m1 14.915V18h-2v-1.08c-2.339-.367-3-2.002-3-2.92h2c.011.143.159 1 2 1c1.38 0 2-.585 2-1c0-.324 0-1-2-1c-3.48 0-4-1.88-4-3c0-1.288 1.029-2.584 3-2.915V6.012h2v1.109c1.734.41 2.4 1.853 2.4 2.879h-1l-1 .018C13.386 9.638 13.185 9 12 9c-1.299 0-2 .516-2 1c0 .374 0 1 2 1c3.48 0 4 1.88 4 3c0 1.288-1.029 2.584-3 2.915'/%3E%3C/svg%3E")}
    ...
    &--mynaui--map-pinned-solid{@include icon("data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cg fill='%23000'%3E%3Cpath d='M17.127 16.255a.834.834 0 0 1 1.118.372l2 4a.835.835 0 0 1-.745 1.206h-15a.833.833 0 0 1-.745-1.206l2-4a.834.834 0 0 1 1.49.746L5.85 20.167h12.3l-1.396-2.794l-.034-.078a.833.833 0 0 1 .406-1.04'/%3E%3Cpath d='M12 1.167c1.848 0 3.602.806 4.883 2.21c2.348 2.577 2.32 5.652 1.253 8.375c-1.056 2.693-3.154 5.144-5.17 6.742a1.54 1.54 0 0 1-1.932 0c-2.016-1.598-4.113-4.049-5.17-6.742C4.796 9.029 4.77 5.954 7.117 3.378C8.397 1.973 10.152 1.167 12 1.167m0 10.666a2.833 2.833 0 1 0 0-5.666a2.833 2.833 0 0 0 0 5.666'/%3E%3Cpath d='M13.167 9a1.167 1.167 0 1 0-2.335 0a1.167 1.167 0 0 0 2.335 0'/%3E%3C/g%3E%3C/svg%3E")}
    ...
    &--feather--globe{@include icon("data:image/svg+xml;base64,")}
